    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-yellow-500 text-white border border-yellow-500 rounded-lg font-['Geist:Medium',sans-serif] hover:bg-yellow-600 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
