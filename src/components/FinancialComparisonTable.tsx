    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-purple-500 text-white border border-purple-500 rounded-lg font-['Geist:Medium',sans-serif] hover:bg-purple-600 transition-colors shadow-sm"
        >
      ...
      <div className="text-neutral-500 font-['Geist:Regular',sans-serif] space-y-1">
        ...
        <div className="hidden md:grid grid-cols-[2fr_1fr_1fr] text-xs items-start">
          <div className="px-6 text-[11px] space-y-1">
            ...
            <p><strong>Souyen (Ivy) Park</strong> – Web Systems &amp; Designer</p>
