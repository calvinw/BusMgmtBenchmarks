...
with open('extracted_financial_data.json', 'r') as f:
...
with open('extracted_financial_data.html', 'w') as f:
    f.write(html_content)

print("HTML file has been generated: extracted_financial_data.html")
